...
2. [Installation](#installation)
   ...
   - [MySQL-Datenbank-Setup](#mysql-datenbank-setup)
   - [Neo4j-Datenbank-Konfiguration (Cloud-basiert)](#neo4j-datenbank-konfiguration-cloud-basiert)
   - [Standard-Admin-Anmeldeinformationen](#standard-admin-anmeldeinformationen)
...
6. [Backend](#backend)
   ...
   - [Bemerkenswerte Endpunkte](#bemerkenswerte-endpunkte)
...
10. [API-Dokumentation](#api-dokumentation)
    ...
    - [Datenbankstruktur](#2-datenbankstruktur)
    - [Allgemeine Informationen](#3-allgemeine-informationen)
    - [Authentifizierung und Benutzerverwaltung](#4-authentifizierung-und-benutzerverwaltung)
    - [Professorenverwaltung](#5-professorenverwaltung)
    - [Kursverwaltung](#6-kursverwaltung)
    - [Klassenverwaltung](#7-klassenverwaltung)
    - [Dokumentenverwaltung (PDFs)](#8-dokumentenverwaltung-pdfs)
    - [Verwaltung des Chatverlaufs](#9-verwaltung-des-chatverlaufs)
    - [Systemfunktionen und Analysen](#10-systemfunktionen-und-analysen)
    - [Konfiguration](#11-konfiguration)
    - [Authentifizierung](#12-authentifizierung)
11. [FAQ](#faq)
...
2. [Installation](#installation-1)
   ...
   - [MySQL Database Setup](#mysql-database-setup-1)
   - [Neo4j Database Configuration (Cloud-Based)](#neo4j-database-configuration-cloud-based-1)
   - [Default Admin Credentials](#default-admin-credentials-1)
...
6. [Backend](#backend-1)
   ...
   - [Notable Endpoints](#notable-endpoints-1)
...
10. [API Documentation](#api-documentation-1)
    ...
    - [Database Structure](#2-database-structure-1)
    - [General Information](#3-general-information-1)
    - [Authentication and User Management](#4-authentication-and-user-management-1)
    - [Professor Management](#5-professor-management-1)
    - [Course Management](#6-course-management-1)
    - [Class Management](#7-class-management-1)
    - [Document Management (PDFs)](#8-document-management-pdfs-1)
    - [Chat History Management](#9-chat-history-management-1)
    - [System Functions and Analytics](#10-system-functions-and-analytics-1)
    - [Configuration](#11-configuration-1)
    - [Authentication](#12-authentication-1)
11. [FAQ](#faq-1)
